<x-layouts.app :title="'Crear Color'">
    ...
    <div class="card">
        <form action="{{route('admin.colors.store')}}" method="POST">
            @csrf
            <div class="mb-4">
                <flux:input class="hover-input" label="Codigo" name="code" placeholder="Escribe el codigo del color (opcional)"></flux:input>
            </div>
            <div class="mb-4">
                <flux:input class="hover-input" label="Nombre" name="name" placeholder="Escribe el nombre del color"></flux:input>
            </div>
