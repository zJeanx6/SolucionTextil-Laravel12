<x-layouts.app :title="'Crear Usuario'">
    ...
    {{-- Formulario/Tarjeta para crear usuario. --}}
    <div class="card">
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="mb-4">
                <flux:input class="hover-input" label="Documento" name="card"
                    placeholder="Escribe el documento de identidad del nuevo usuario">Documento</flux:input>
            </div>

            <div class="mb-4">
                <flux:input class="hover-input" label="Nombre" name="name"
                    placeholder="Escribe el nombre del nuevo usuario">Nombre</flux:input>
            </div>

            <div class="mb-4">
                <flux:input class="hover-input" label="Apellido" name="last_name"
                    placeholder="Escribe el apellido del nuevo usuario">Apellido</flux:input>
            </div>

            <div class="mb-4">
                <flux:input class="hover-input" label="Email" name="email"
                    placeholder="Escribe el email del nuevo usuario">Email</flux:input>
            </div>

            <div class="mb-4">
                <flux:input class="hover-input" label="Teléfono" name="phone"
                    placeholder="Escribe el teléfono del nuevo usuario">Telefono</flux:input>
            </div>

            <div class="mb-4">
                <flux:input class="hover-input" label="Contraseña" name="password"
                    placeholder="Escribe la contraseña del nuevo usuario">Contraseña</flux:input>
            </div>
            <div class="mb-4">
                <flux:input class="hover-input" label="Confirmar Contraseña" name="password_confirmation"
                    placeholder="Confirma la contraseña del nuevo usuario">Confirmar Contraseña</flux:input>
            </div>
