<div>
    ...
    @if ($view === 'index')
        ...
        <div class="flex gap-4 mb-4">
            <div class="w-1/2">
                <flux:select wire:model="modelSelected" wire:change="loadTypes">
            ...
            <div class="w-1/2">
                <flux:input type="text" wire:model.live="search" class="hover-input" name="search" placeholder="Buscar por nombre..." />
            </div>
        </div>
