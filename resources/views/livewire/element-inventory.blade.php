<div>
    ...
    @if ($view === 'index')
        ...
        <div class="card mb-4">
            <div class="w-full">
                <div class="w-full">
                    <flux:input class="hover-input" type="text" name="search" placeholder="Buscar elementos..."
            ...
            <table class="table">
                <thead class="head-table">
                    <tr>
                        ...
                        <th class="head-table-item">Tipo/Categoria</th>
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-4">
                    ...
                    @if (in_array('color_id', $visibleFields))
                        <flux:select wire:model="color_id">
                            <flux:select.option value=""> Selecciona color </flux:select.option>
